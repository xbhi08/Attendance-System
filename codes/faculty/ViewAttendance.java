...
import gui.admin.GenerateReportFrame;
...
public class ViewAttendance extends JFrame implements ActionListener {
	    ...
	    public ViewAttendance(String classId, String className) {
	        super();
	    ...
	    public void addClassTable(String classId, String currentDate, String additionalQuery) {
	    	dateSearch.setSearchText(currentDate);
	        dataFound = false;
	        ...
	        if (!dataFound) {
	            String msg = "Class: " + className + /*"\nDate: " + currentDate + */"\nNo attendance was taken for today. \nDate: " + currentDate;
